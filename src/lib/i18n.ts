...
const messages = {
  en: {
    ...
    overlayStatusHint: 'Configure favorite regions in the extension panel.',
    ...
    overlayStatusNoFavorites: 'No regions available. Configure them in the panel.',
    overlayStatusSwitching: 'Switching to {region}…',
    embedLabel: 'Region {region}',
    embedEmpty: 'Choose favorite regions in the extension first.',
  },
  zh: {
    headerTitle: 'AppStoreSwitcher',
    headerLinkLabel: 'apps.apple.com',
    ...
    overlayStatusHint: '请在侧边栏中配置常用地区。',
    ...
    overlayStatusNoFavorites: '没有可用地区，请在侧边栏中配置。',
    overlayStatusSwitching: '正在切换到 {region}…',
    embedLabel: '地区 {region}',
    embedEmpty: '请先在扩展中配置常用地区。',
  },
} as const;
